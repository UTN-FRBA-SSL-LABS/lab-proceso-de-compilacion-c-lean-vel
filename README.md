...
> **R:**El numero de lineas es mayor porque el preprocesador reemplaza las directivas y macros por su codigo expandible real
...
> **R:**Porque el preprocesador elimina todos los comentarios
...
> **R:**Las primeras dos instrucciones arman el marco de la función en la pila (guardan el estado anterior y establecen la nueva base). Las siguientes dos toman los parámetros a y b, que llegaron en los registros %ecx y %edx, y los guardan en la pila para poder usarlos durante la función.
...
> **R:**area_circulo aparece como U (Undefined) en programa.o porque está definida en matematica.c, no en programa.c
...
> **R:**Quedan símbolos U porque corresponden a funciones de la biblioteca dinámica del sistema 
...
> **R:**La macro funcion se reemplaza textualemnte por el preprocesador en cambio una funcion real existe como codigo hasta la etapa de ensamblado
...
> **R:**Un símbolo de tipo T es una función: su código vive en la sección .text del archivo objeto, que contiene instrucciones ejecutables. Un símbolo de tipo D es una variable global con valor inicial: vive en la sección .data, que contiene datos que el programa necesita al arrancar. Por ejemplo, sumar aparece como T y una variable global como int x = 5; aparecería como D.
